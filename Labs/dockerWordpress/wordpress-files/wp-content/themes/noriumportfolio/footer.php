                    ...
                    <div class="col-xl-12">
                        <div class="footer-bottom text-center">
                            ...
                            <?php if(!empty($oliva_footer_copyright_text)) : ?>
                                ...
                                printf( esc_html__( 'Theme %2$s  By  %1$s', 'noriumportfolio' ), '<a href="https://ordainit.com" target="_blank" >ordainIT</a>' , '<a href="https://ordainit.com/noriumportfolio/">Norium Portfolio</a>' );?>
                            <?php else : ?>
                                <?php esc_html_e('&copy; All Right Reserved ','noriumportfolio'); bloginfo('title');?> <?php echo  esc_html(date_i18n( __( 'Y' , 'noriumportfolio' ) ));?>
                                <?php
                                /* translators: 1: Theme name, 2: Theme author. */
                                printf( esc_html__( 'Theme %2$s  By  %1$s', 'noriumportfolio' ), '<a href="https://ordainit.com/"  >OrdainIT</a>' , '<a href="https://ordainit.com/noriumportfolio/">Norium Portfolio</a>' );?>
                            <?php endif; ?>
                            </p>
