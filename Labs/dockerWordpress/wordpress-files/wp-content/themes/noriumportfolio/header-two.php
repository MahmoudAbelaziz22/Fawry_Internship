...
<div id="page" class="site">
    ...
    <!-- Dark Mode ends -->
<?php endif;?>
	<header id="masthead" class="site-header elementor_header">
        ...
        <div class="main-header-menu">
	        <div class="container">
				<div class="row">
					<div class="col-lg-4 col-xl-4 col-md-12 col-sm-6 col">
					...
					<div class="col-xl-8 col-lg-8 col-md-12 col-sm-6 col text-right">
