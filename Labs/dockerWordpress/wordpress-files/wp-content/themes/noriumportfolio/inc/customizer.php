...
Kirki::add_field( 'oliva_customizer_config', [
	...
	'label'       => esc_html__( 'Header top enable? For Pro', 'noriumportfolio' ),
	'section'     => 'header_top',
	'default'     => 'off',
	'priority'    => 10,
	'choices'     => [
...
Kirki::add_field( 'oliva_customizer_config', [
	...
	'description' => esc_html__( 'You Must Use Png Transparent Image For Better Look (Dimension( 495x670px ))', 'noriumportfolio' ),
	'section'     => 'oliva_front_page_options',
	'default'     => '',
	'choices'     => [
		'save_as' => 'array',
