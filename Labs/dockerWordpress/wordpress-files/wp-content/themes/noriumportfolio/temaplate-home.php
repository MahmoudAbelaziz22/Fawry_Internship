        ...
        <div class="container">
            ...
            <div class="row pt-30">
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    ...
                    <div class="banner-content">
                        ...
                        <div class="banner-counter d-flex align-items-center justify-content-start">
                            ...
                            <div class="counter-box">
                                ...
                                <span class="counter">
                                    ...
                                    <?php echo esc_html($banner_working_exs['ex_number'], 'noriumportfolio-pro');?> 
                        ...
                        <div class="banner-btn pt-60 pos-relative">
                            ...
                            <a href="<?php echo esc_url(get_theme_mod('banner_btn_link'));?>" class="b-primary mb-5 mb-sm-0"><?php echo esc_html(get_theme_mod('banner_btn'), 'noriumportfolio-pro');?> <i class="fas fa-envelope pl-10"></i></a>
                ...
                <div class="hero-img-area">
                    <img src="<?php echo esc_url($bannar_img['url']);?>" alt="">
                </div>
